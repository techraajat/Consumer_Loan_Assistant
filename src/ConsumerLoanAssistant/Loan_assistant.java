...
public class Loan_assistant extends JFrame {
    ...
    private void computeButtonActionPerformed(ActionEvent e)
    {
        ...
        if(validateDecimalNumber(interestTextField)){
            ...
            JOptionPane.showConfirmDialog(null, "Invalid or empty Interest Rate entry.\nPleasures.", "Interest Input Error", JOptionPane.DEFAULT_OPTION,JOptionPane.INFORMATION_MESSAGE);
            return;
        }
